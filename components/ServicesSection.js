...
export default function ServicesSection() {
  ...
  useEffect(() => {
    const getServices = async () => {
      try {
        const result = await axios.get("http://localhost:5000/api/consumerservices/getallservices");
  ...
  if (loading) {
    return (<section className="bg-slate-50 py-20"> <div className="container-x text-center"> <p>Loading services...</p> </div> </section>
    );
  }

  return (<section id="services" className="bg-slate-50 py-20"> <div className="container-x"> <div className="text-center"> <p className="section-eyebrow">Our Services</p>
